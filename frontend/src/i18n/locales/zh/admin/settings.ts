export default {
    settings: {
      ...
      features: {
        ...
        availableChannels: {
          title: '价格页面',
          description: '向已登录用户按访问分组展示模型原价和倍率调整后的实际价格。默认关闭。',
      ...
      security: {
        ...
        sessionBinding: '会话设备绑定',
        sessionBindingHint: '将登录会话与浏览器 User-Agent 绑定；网络或 IP 变化不会导致用户退出登录。',
      ...
      apiKeyAcl: {
        ...
        description: '控制 API Key 白/黑名单与操作审计日志使用哪个客户端 IP 判断',
      ...
      site: {
        ...
        currencySymbolHint: '显示在余额和价格数值前；留空时改为在数值后显示货币名称。',
        currencyName: '货币名称',
        currencyNamePlaceholder: '例如 USD、积分',
        currencyNameHint: '用于金额标签，并在未设置符号时显示在数值后。',
        apiBaseUrl: 'API 端点地址',
