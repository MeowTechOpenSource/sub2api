export default {
  dashboard: {
    ...
    expiringBalanceTitle: '即将过期的余额',
    happyHourEyebrow: '促销费率',
    happyHourTitle: '欢乐时光日程',
    happyHourPricing: '查看定价',
    happyHourLive: '进行中',
    happyHourFree: '免费',
    expiringBalanceItem: '{amount} 将于 {time} 过期',
    balanceDetails: '余额明细',
    availableBalance: '可用余额',
    noExpiringBalance: '没有即将过期的余额。'
  },
  ...
  keys: {
    ...
    // 配额和有效期
    quotaLimit: '额度限制',
    quotaAmount: '额度金额（{currency}）',
    quotaAmountPlaceholder: '输入 {currency} 额度限制',
  ...
  availableChannels: {
    title: '价格',
    description: '按访问分组比较模型原价与倍率调整后的实际价格。',
    catalogLabel: '模型价格',
    model: '模型',
    availability: '可用状态',
    access: '访问分组',
    ...
    emptyHint: '请尝试其他分组、平台或搜索词。',
    showingModels: '当前显示 {count} 个模型',
    priceNote: '选择分组后可对比该分组实际价格与模型原价。',
    originalPrice: '原价',
    effectivePrice: '实际价格',
    adjustment: '价格调整',
    standardPrice: '模型原价',
    discount: '节省 {percent}%',
    surcharge: '高于原价 {percent}%',
    ...
    happyHour: {
      ...
      serverTime: '服务器时间',
      free: '免费',
      quotaLeft: '分组 5 小时剩余容量',
      quota5h: '5 小时容量',
      quota7d: '7 天容量',
      quotaSummary: '{percent}% · {remaining}/{total} 个账号容量',
      unmetered: '没有可计量的 5 小时容量'
    },
    stats: { models: '模型', available: '当前可用', providers: '平台', groups: '访问分组' },
  ...
  modelPlaza: {
    ...
    memberDescription: '比较你可访问的分组、实时活动倍率与模型实付价格。',
    catalogLabel: '模型定价',
    refresh: '刷新定价',
    tryAgain: '重试',
    loading: '加载中...',
    ...
    stats: { models: '模型', groups: '访问分组', platforms: '平台', liveEvents: '进行中活动' },
    happyHour: { title: '欢乐时光', active: '进行中', scheduled: '已排期', free: '免费', quota: '分组 5 小时容量', quota5h: '5 小时容量', quota7d: '7 天容量', serverTime: '服务器时间' },
    badges: {
      exclusive: '专属分组',
      subscription: '订阅'
    },
  ...
  chat: {
    title: '聊天',
    description: '使用自己的 API 密钥与可用模型对话。',
    newChat: '新建对话',
    searchHistory: '搜索对话',
    history: '对话记录',
    noHistory: '没有匹配的对话',
    ...
    selectGroup: '选择分组',
    changeGroup: '更改控制台分组',
    selectGroupTitle: '选择控制台分组',
    selectGroupDescription: '控制台会为此分组创建并管理专用 API 密钥，用量按所选分组的访问权限和计费规则计算。',
    standardGroup: '标准分组',
    subscriptionGroup: '订阅分组',
    welcomeTitle: '有什么可以帮你？',
    welcomeDescription: '选择模型，然后输入问题，或附加图片及文档。',
    ...
    downloadImage: '下载图片',
    imageHistory: '生成历史',
    clearImageHistory: '清除生成历史',
    noImageHistory: '尚无生成图片',
    send: '发送消息',
    messagePlaceholder: '向模型发送消息...',
    usageNotice: '请求使用所选 API 密钥，并计入正常用量和计费。',
    contextUsed: '上下文',
    sessionCost: '预估费用',
    sessionStandardCost: '标准费用总计',
    tokensShort: '令牌',
    inputTokensShort: '输入',
    outputTokensShort: '输出',
    deleteChat: '删除对话',
    deleteConfirm: '此对话及其本地记录将被永久删除。',
    promptSummarize: '总结附件文档，并列出关键决定。',
    promptResearch: '使用最新网页来源研究这个主题。',
    promptImage: '生成一张精致的产品概念图。',
    failedKeys: '无法加载 API 密钥。',
    failedModels: '无法加载此 API 密钥可用的模型。',
    creatingKey: '正在创建聊天密钥...',
    noAvailableGroup: '没有可分配给聊天密钥的可用分组。',
    ...
    tools: '工具与附件',
    photos: '图片',
    photosHint: 'PNG、JPG、WebP 等图片格式',
    documents: '文档',
    documentsHint: 'PDF、Word、幻灯片、文本及 Markdown',
    dataFiles: '数据与数据库文件',
    dataFilesHint: 'CSV、Excel、JSON、XML、YAML 及 SQL',
    webSearchHint: '从网络获取最新信息',
    searchedWeb: '已搜索网络',
    searchedWebFor: '已搜索「{query}」',
    webSource: '来源：{title}',
    referencedDocument: '已参考 {name}',
    webSearchCost: '网络搜索',
    imageGenerationHint: '使用支持的模型生成图片',
    workspaceMode: '工作区模式',
    workspaceModeHint: '综合分析附件中的项目及数据文件',
    reasoningLevel: '思考等级',
    reasoningLow: '快速',
    reasoningMedium: '均衡',
    reasoningHigh: '深入',
    ...
    chatMode: '聊天',
    imageStudio: '生成图片',
    imageStudioDescription: '使用图片模型生成、编辑和反复调整作品。',
    imageModel: '图片模型',
    ...
    referenceImagesHint: '最多添加四张图片，用于引导构图、风格或编辑内容。',
    imageCanvasTitle: '生成结果会显示在这里',
    imageCanvasHint: '选择模型、描述想要的效果，然后开始生成。',
    creatingImage: '正在生成图片...',
    imageCreated: '已生成 {count} 张图片。',
    emptyImageResponse: '图片模型没有返回图片。',
    knowledgeBase: '知识库',
    memory: '记忆',
    knowledgeDescription: '这里启用的可复用资料会随新的聊天请求一同发送。',
    addKnowledgeFiles: '添加知识文件',
    knowledgeFileHint: '文档、电子表格、数据及 SQL 文件',
    knowledgeNoteTitle: '笔记标题',
    knowledgeNotePlaceholder: '添加参考资料、术语、政策或项目背景...',
    addNote: '添加笔记',
    enableKnowledge: '使用此资料',
    disableKnowledge: '停止使用此资料',
    noKnowledge: '尚未保存知识资料',
    knowledgeLimit: '最多可同时启用 {count} 项知识资料。',
    untitledNote: '未命名笔记',
    memoryDescription: '保存需要在不同对话之间沿用的事实和偏好。',
    useMemory: '在聊天中使用记忆',
    useMemoryHint: '在之后的聊天请求中附带已保存的记忆',
    savedMemory: '已保存的记忆',
    memoryPlaceholder: '例如：回答尽量简洁。我的项目使用 Vue 和 Go...',
    memoryPrivacy: '记忆仅保存在此浏览器，并只会在启用时发送。',
    clearMemory: '清除记忆',
