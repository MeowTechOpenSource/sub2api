export default {
  dashboard: {
    ...
    expiringBalanceTitle: 'Expiring balance',
    happyHourEyebrow: 'Promotional rates',
    happyHourTitle: 'Happy Hour schedule',
    happyHourPricing: 'View pricing',
    happyHourLive: 'Live',
    happyHourFree: 'Free',
    expiringBalanceItem: '{amount} expires on {time}',
    balanceDetails: 'Balance details',
    availableBalance: 'Available balance',
    noExpiringBalance: 'No balance credits are scheduled to expire.'
  },
  ...
  keys: {
    ...
    quotaAmount: 'Quota Amount ({currency})',
    quotaAmountPlaceholder: 'Enter quota limit in {currency}',
  ...
  availableChannels: {
    title: 'Pricing',
    description: 'Compare original model pricing with the price for each access group.',
    catalogLabel: 'Model pricing',
    model: 'Model',
    ...
    groupFilter: 'Choose an access group',
    platformFilter: 'Filter by provider',
    emptyHint: 'Try another group, provider, or search term.',
    showingModels: 'Showing {count} models',
    priceNote: 'Select a group to compare its effective price with the original price.',
    originalPrice: 'Original',
    effectivePrice: 'Your price',
    adjustment: 'Adjustment',
    standardPrice: 'Original price',
    discount: 'Save {percent}%',
    surcharge: '{percent}% above original',
    rateMultiplier: '{rate}x multiplier',
    happyHour: {
      title: 'Happy Hour',
      active: 'Live now',
      scheduled: 'Scheduled',
      rate: 'Happy Hour rate',
      serverTime: 'Server time',
      free: 'Free',
      quotaLeft: 'Group 5h capacity left',
      quota5h: '5-hour capacity',
      quota7d: '7-day capacity',
      quotaSummary: '{percent}% · {remaining}/{total} account capacity',
      unmetered: 'No metered 5h capacity'
    },
    stats: { models: 'Models', available: 'Available now', providers: 'Providers', groups: 'Access groups' },
    searchPlaceholder: 'Search channels or models...',
    empty: 'No pricing data available',
  ...
  modelPlaza: {
    ...
    memberDescription: 'Compare your accessible groups, live event rates, and effective model pricing.',
    catalogLabel: 'Model pricing',
    ...
    stats: { models: 'Models', groups: 'Access groups', platforms: 'Platforms', liveEvents: 'Live events' },
    happyHour: { title: 'Happy Hour', active: 'Live now', scheduled: 'Scheduled', free: 'Free', quota: '5-hour group capacity', quota5h: '5-hour capacity', quota7d: '7-day capacity', serverTime: 'Server time' },
    badges: {
      exclusive: 'Exclusive',
  ...
  chat: {
    title: 'Chat',
    description: 'Chat with available models using your own API key.',
    newChat: 'New chat',
    ...
    changeGroup: 'Change console group',
    selectGroupTitle: 'Choose a console group',
    selectGroupDescription: 'The console will create and manage a private API key for this group. Usage follows the selected group’s access and billing rules.',
    standardGroup: 'Standard group',
    subscriptionGroup: 'Subscription group',
    welcomeTitle: 'What can I help with?',
    welcomeDescription: 'Choose a model, then ask a question or attach an image or document.',
    ...
    responseCost: 'Response',
    standardCost: 'Standard',
    userCost: 'Your cost',
    happyHour: 'Happy Hour',
    happyHourFree: 'Free rate',
    downloadImage: 'Download image',
    imageHistory: 'Generation history',
    clearImageHistory: 'Clear generation history',
    noImageHistory: 'No generated images yet',
    send: 'Send message',
    messagePlaceholder: 'Message a model...',
    usageNotice: 'Requests use the selected API key and count toward its normal usage and billing.',
    contextUsed: 'Context',
    sessionCost: 'Estimated spend',
    sessionStandardCost: 'Standard spend',
    tokensShort: 'tokens',
    inputTokensShort: 'in',
    outputTokensShort: 'out',
    deleteChat: 'Delete chat',
    deleteConfirm: 'This conversation and its local history will be permanently deleted.',
    promptSummarize: 'Summarize an attached document and list the key decisions.',
    promptResearch: 'Research this topic using current web sources.',
    promptImage: 'Create a polished product concept image.',
    failedKeys: 'Could not load API keys.',
    failedModels: 'Could not load models for this API key.',
    creatingKey: 'Creating chat key...',
    noAvailableGroup: 'No available group can be assigned to the chat key.',
    searchModels: 'Search models or providers',
    noModels: 'No matching models',
    pricingUnavailable: 'Pricing unavailable',
    inputShort: 'Input',
    outputShort: 'Output',
    tools: 'Tools and attachments',
    photos: 'Photos',
    photosHint: 'PNG, JPG, WebP and other images',
    documents: 'Documents',
    documentsHint: 'PDF, Word, slides, text and Markdown',
    dataFiles: 'Data and database files',
    dataFilesHint: 'CSV, Excel, JSON, XML, YAML and SQL',
    webSearchHint: 'Use current information from the web',
    searchedWeb: 'Searched the web',
    searchedWebFor: 'Searched for “{query}”',
    webSource: 'Source: {title}',
    referencedDocument: 'Referenced {name}',
    webSearchCost: 'Web search',
    imageGenerationHint: 'Create images with a supported model',
    workspaceMode: 'Workspace mode',
    workspaceModeHint: 'Analyze attached project and data files together',
    reasoningLevel: 'Reasoning level',
    reasoningLow: 'Quick',
    reasoningMedium: 'Balanced',
    reasoningHigh: 'Deep',
    reasoningXHigh: 'Extended',
    thinking: 'Thinking',
    reasoning: 'Reasoning summary',
    thoughtFor: 'Thought for {seconds}s',
    preparingThoughts: 'Preparing a response...',
    chatMode: 'Chat',
    imageStudio: 'Create image',
    imageStudioDescription: 'Generate, edit and iterate with image models.',
    ...
    referenceImagesHint: 'Add up to four images to guide composition, style or edits.',
    imageCanvasTitle: 'Your images will appear here',
    imageCanvasHint: 'Choose a model, describe the result and generate.',
    creatingImage: 'Creating your image...',
    imageCreated: '{count} image generated.',
    emptyImageResponse: 'The image model returned no image.',
    knowledgeBase: 'Knowledge base',
    memory: 'Memory',
    knowledgeDescription: 'Reusable sources enabled here are included with new chat requests.',
    addKnowledgeFiles: 'Add knowledge files',
    knowledgeFileHint: 'Documents, spreadsheets, data and SQL files',
    knowledgeNoteTitle: 'Note title',
    knowledgeNotePlaceholder: 'Add reference information, terminology, policies or project context...',
    addNote: 'Add note',
    enableKnowledge: 'Use this source',
    disableKnowledge: 'Stop using this source',
    noKnowledge: 'No saved knowledge yet',
    knowledgeLimit: 'Up to {count} knowledge sources can be active at once.',
    untitledNote: 'Untitled note',
    memoryDescription: 'Save facts and preferences that should carry across conversations.',
    useMemory: 'Use memory in chat',
    useMemoryHint: 'Include the saved memory with future chat requests',
    savedMemory: 'Saved memory',
    memoryPlaceholder: 'For example: Prefer concise answers. My project uses Vue and Go. Use Hong Kong Traditional Chinese...',
    memoryPrivacy: 'Memory stays in this browser and is only sent when enabled.',
    clearMemory: 'Clear memory',
    fileTooLarge: '{name} is larger than 10 MB.',
